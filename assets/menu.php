...
?>
                  <a href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown" aria-expanded="false">
                    ...
                    <?php $alertreserve = mysql_query("SELECT * FROM tbl_reserve 
                                            ...
                                            AND tbl_reserve.reserve_method = 'ON'
                    ...
                    ?>
                    <?php if($al!=0){?><span class="badge bg-red"><?php echo number_format($al);?></span><?php }?>
                  </a>
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    ...
                    <li>
                      <a href="https://www.royalferrygroup.com/ferrybooking/rpladmin_booking/checkpayment/<?php echo $alerr1['bid'];?>">
                        ...
                        <span>
                          <span><?php $rdate1 = explode(" ", $alerr1['reserve_date']);
                              $rdate = explode("-", $rdate1[0]); echo "Online #".substr($rdate[0],2,4).$alerr1['bid'];?></span>
