        ...
        $sql = "select * from tbl_fares_time 
                ...
                where tbl_fares_time.fares_id = '2' and tbl_fares_time.ship_id = '2'
                                      ...
                                      <td width="32" height="32" align="center"
                                        <?php /* 1 */ if($i>0 && $i<8 && (($ii>=1 && $ii<=3) || ($ii>=5 && $ii<=8) || ($ii>=12 && $ii<=15) || ($ii>=17 && $ii<=19))){
                                          ...
                                          $seato = mysql_fetch_array(mysql_query("select * from tbl_seat_other a 
                                            ...
                                            where b.seat_no='".$iii.$char."' and a.seat_other_date = '$dateseatt' and a.fares_id = '2' and b.class_id = '4'"));
                                          ...
                                          $value_seat = mysql_fetch_array(mysql_query("select * from tbl_reservedet a
                                            ...
                                            where d.seat_no='".$iii.$char."' and a.reservedet_date = '$dateseatt' and c.fares_id = '2' and cl.ship_id = '2' and b.reserve_cancel = '0' and b.reserve_status != 'D' and a.reservedet_st != '3' and d.class_id = '4'"));
                                  ...
                                  <tr>
                                    ...
                                    <td width="35" height="35" align="center" 
                                      <?php 
                                        $seato = mysql_fetch_array(mysql_query("select * from tbl_seat_other a 
                                          INNER JOIN tbl_seat b ON a.seat_id=b.seat_id 
                                          where b.seat_no='1V' and a.seat_other_date = '$dateseatt' and a.fares_id = '2' and b.class_id = '6'"));
                                        $seatst = mysql_fetch_array(mysql_query("select * from tbl_seat where seat_no='1V' and seat_st = '0'"));
                                        $value_seat = mysql_fetch_array(mysql_query("select * from tbl_reservedet a
                                          INNER JOIN (tbl_reserve b,tbl_calfares c,tbl_class cl,tbl_seat d)
                                          ON (a.reserve_id=b.reserve_id AND b.cal_id=c.cal_id AND c.class_id=cl.class_id AND a.seat_id=d.seat_id)
                                          where d.seat_no='1V' and a.reservedet_date = '$dateseatt' and c.fares_id = '2' and cl.ship_id = '2' and b.reserve_cancel = '0' and b.reserve_status != 'D' and a.reservedet_st != '3' and d.class_id = '6'"));
                                  ...
                                  <tr>
                                    ...
                                    <td width="35" height="35" align="center"
                                      <?php 
                                        $seato = mysql_fetch_array(mysql_query("select * from tbl_seat_other a 
                                          INNER JOIN tbl_seat b ON a.seat_id=b.seat_id 
                                          where b.seat_no='1A' and a.seat_other_date = '$dateseatt' and a.fares_id = '2' and b.class_id = '5'"));
                                        $seatst = mysql_fetch_array(mysql_query("select * from tbl_seat where seat_no='1A' and seat_st = '0'"));
                                        $value_seat = mysql_fetch_array(mysql_query("select * from tbl_reservedet a
                                          INNER JOIN (tbl_reserve b,tbl_calfares c,tbl_class cl,tbl_seat d)
                                          ON (a.reserve_id=b.reserve_id AND b.cal_id=c.cal_id AND c.class_id=cl.class_id AND a.seat_id=d.seat_id)
                                          where d.seat_no='1A' and a.reservedet_date = '$dateseatt' and c.fares_id = '2' and cl.ship_id = '2' and b.reserve_cancel = '0' and b.reserve_status != 'D' and a.reservedet_st != '3' and d.class_id = '5'"));
                                    ...
                                    <td width="35" height="35" align="center"
                                      <?php 
                                        $seato = mysql_fetch_array(mysql_query("select * from tbl_seat_other a 
                                          INNER JOIN tbl_seat b ON a.seat_id=b.seat_id 
                                          where b.seat_no='1B' and a.seat_other_date = '$dateseatt' and a.fares_id = '2' and b.class_id = '5'"));
                                        $seatst = mysql_fetch_array(mysql_query("select * from tbl_seat where seat_no='1B' and seat_st = '0'"));
                                        $value_seat = mysql_fetch_array(mysql_query("select * from tbl_reservedet a
                                          INNER JOIN (tbl_reserve b,tbl_calfares c,tbl_class cl,tbl_seat d)
                                          ON (a.reserve_id=b.reserve_id AND b.cal_id=c.cal_id AND c.class_id=cl.class_id AND a.seat_id=d.seat_id)
                                          where d.seat_no='1B' and a.reservedet_date = '$dateseatt' and c.fares_id = '2' and cl.ship_id = '2' and b.reserve_cancel = '0' and b.reserve_status != 'D' and a.reservedet_st != '3' and d.class_id = '5'"));
                                    ...
                                    <td width="35" height="35" align="center"
                                      <?php 
                                        $seato = mysql_fetch_array(mysql_query("select * from tbl_seat_other a 
                                          INNER JOIN tbl_seat b ON a.seat_id=b.seat_id 
                                          where b.seat_no='1C' and a.seat_other_date = '$dateseatt' and a.fares_id = '2' and b.class_id = '5'"));
                                        $seatst = mysql_fetch_array(mysql_query("select * from tbl_seat where seat_no='1C' and seat_st = '0'"));
                                        $value_seat = mysql_fetch_array(mysql_query("select * from tbl_reservedet a
                                          INNER JOIN (tbl_reserve b,tbl_calfares c,tbl_class cl,tbl_seat d)
                                          ON (a.reserve_id=b.reserve_id AND b.cal_id=c.cal_id AND c.class_id=cl.class_id AND a.seat_id=d.seat_id)
                                          where d.seat_no='1C' and a.reservedet_date = '$dateseatt' and c.fares_id = '2' and cl.ship_id = '2' and b.reserve_cancel = '0' and b.reserve_status != 'D' and a.reservedet_st != '3' and d.class_id = '5'"));
                                    ...
                                    <td width="35" height="35" align="center"
                                      <?php 
                                        $seato = mysql_fetch_array(mysql_query("select * from tbl_seat_other a 
                                          INNER JOIN tbl_seat b ON a.seat_id=b.seat_id 
                                          where b.seat_no='1L' and a.seat_other_date = '$dateseatt' and a.fares_id = '2' and b.class_id = '5'"));
                                        $seatst = mysql_fetch_array(mysql_query("select * from tbl_seat where seat_no='1L' and seat_st = '0'"));
                                        $value_seat = mysql_fetch_array(mysql_query("select * from tbl_reservedet a
                                          INNER JOIN (tbl_reserve b,tbl_calfares c,tbl_class cl,tbl_seat d)
                                          ON (a.reserve_id=b.reserve_id AND b.cal_id=c.cal_id AND c.class_id=cl.class_id AND a.seat_id=d.seat_id)
                                          where d.seat_no='1L' and a.reservedet_date = '$dateseatt' and c.fares_id = '2' and cl.ship_id = '2' and b.reserve_cancel = '0' and b.reserve_status != 'D' and a.reservedet_st != '3' and d.class_id = '5'"));
                                    ...
                                    <td width="35" height="35" align="center"
                                      <?php 
                                        $seato = mysql_fetch_array(mysql_query("select * from tbl_seat_other a 
                                          INNER JOIN tbl_seat b ON a.seat_id=b.seat_id 
                                          where b.seat_no='1M' and a.seat_other_date = '$dateseatt' and a.fares_id = '2' and b.class_id = '5'"));
                                        $seatst = mysql_fetch_array(mysql_query("select * from tbl_seat where seat_no='1M' and seat_st = '0'"));
                                        $value_seat = mysql_fetch_array(mysql_query("select * from tbl_reservedet a
                                          INNER JOIN (tbl_reserve b,tbl_calfares c,tbl_class cl,tbl_seat d)
                                          ON (a.reserve_id=b.reserve_id AND b.cal_id=c.cal_id AND c.class_id=cl.class_id AND a.seat_id=d.seat_id)
                                          where d.seat_no='1M' and a.reservedet_date = '$dateseatt' and c.fares_id = '2' and cl.ship_id = '2' and b.reserve_cancel = '0' and b.reserve_status != 'D' and a.reservedet_st != '3' and d.class_id = '5'"));
                                    ...
                                    <td width="35" height="35" align="center"
                                      <?php 
                                        $seato = mysql_fetch_array(mysql_query("select * from tbl_seat_other a 
                                          INNER JOIN tbl_seat b ON a.seat_id=b.seat_id 
                                          where b.seat_no='1N' and a.seat_other_date = '$dateseatt' and a.fares_id = '2' and b.class_id = '5'"));
                                        $seatst = mysql_fetch_array(mysql_query("select * from tbl_seat where seat_no='1N' and seat_st = '0'"));
                                        $value_seat = mysql_fetch_array(mysql_query("select * from tbl_reservedet a
                                          INNER JOIN (tbl_reserve b,tbl_calfares c,tbl_class cl,tbl_seat d)
                                          ON (a.reserve_id=b.reserve_id AND b.cal_id=c.cal_id AND c.class_id=cl.class_id AND a.seat_id=d.seat_id)
                                          where d.seat_no='1N' and a.reservedet_date = '$dateseatt' and c.fares_id = '2' and cl.ship_id = '2' and b.reserve_cancel = '0' and b.reserve_status != 'D' and a.reservedet_st != '3' and d.class_id = '5'"));
                                  ...
                                  <tr>
                                    ...
                                    <td width="35" height="35" align="center"
                                      <?php 
                                        $seato = mysql_fetch_array(mysql_query("select * from tbl_seat_other a 
                                          INNER JOIN tbl_seat b ON a.seat_id=b.seat_id 
                                          where b.seat_no='1D' and a.seat_other_date = '$dateseatt' and a.fares_id = '2' and b.class_id = '5'"));
                                        $seatst = mysql_fetch_array(mysql_query("select * from tbl_seat where seat_no='1D' and seat_st = '0'"));
                                        $value_seat = mysql_fetch_array(mysql_query("select * from tbl_reservedet a
                                          INNER JOIN (tbl_reserve b,tbl_calfares c,tbl_class cl,tbl_seat d)
                                          ON (a.reserve_id=b.reserve_id AND b.cal_id=c.cal_id AND c.class_id=cl.class_id AND a.seat_id=d.seat_id)
                                          where d.seat_no='1D' and a.reservedet_date = '$dateseatt' and c.fares_id = '2' and cl.ship_id = '2' and b.reserve_cancel = '0' and b.reserve_status != 'D' and a.reservedet_st != '3' and d.class_id = '5'"));
                                    ...
                                    <td width="35" height="35" align="center"
                                      <?php 
                                        $seato = mysql_fetch_array(mysql_query("select * from tbl_seat_other a 
                                          INNER JOIN tbl_seat b ON a.seat_id=b.seat_id 
                                          where b.seat_no='1E' and a.seat_other_date = '$dateseatt' and a.fares_id = '2' and b.class_id = '5'"));
                                        $seatst = mysql_fetch_array(mysql_query("select * from tbl_seat where seat_no='1E' and seat_st = '0'"));
                                        $value_seat = mysql_fetch_array(mysql_query("select * from tbl_reservedet a
                                          INNER JOIN (tbl_reserve b,tbl_calfares c,tbl_class cl,tbl_seat d)
                                          ON (a.reserve_id=b.reserve_id AND b.cal_id=c.cal_id AND c.class_id=cl.class_id AND a.seat_id=d.seat_id)
                                          where d.seat_no='1E' and a.reservedet_date = '$dateseatt' and c.fares_id = '2' and cl.ship_id = '2' and b.reserve_cancel = '0' and b.reserve_status != 'D' and a.reservedet_st != '3' and d.class_id = '5'"));
                                    ...
                                    <td width="35" height="35" align="center"
                                      <?php 
                                        $seato = mysql_fetch_array(mysql_query("select * from tbl_seat_other a 
                                          INNER JOIN tbl_seat b ON a.seat_id=b.seat_id 
                                          where b.seat_no='1F' and a.seat_other_date = '$dateseatt' and a.fares_id = '2' and b.class_id = '5'"));
                                        $seatst = mysql_fetch_array(mysql_query("select * from tbl_seat where seat_no='1F' and seat_st = '0'"));
                                        $value_seat = mysql_fetch_array(mysql_query("select * from tbl_reservedet a
                                          INNER JOIN (tbl_reserve b,tbl_calfares c,tbl_class cl,tbl_seat d)
                                          ON (a.reserve_id=b.reserve_id AND b.cal_id=c.cal_id AND c.class_id=cl.class_id AND a.seat_id=d.seat_id)
                                          where d.seat_no='1F' and a.reservedet_date = '$dateseatt' and c.fares_id = '2' and cl.ship_id = '2' and b.reserve_cancel = '0' and b.reserve_status != 'D' and a.reservedet_st != '3' and d.class_id = '5'"));
                                    ...
                                    <?php for($ii=0;$ii<=20;$ii++){ 
                                      ...
                                      <td width="35" height="35" align="center"
                                        <?php /* 4 */ if($i==18 && $ii>=9 && $ii<=11){$iii=$i-17;
                                          ...
                                          $seato = mysql_fetch_array(mysql_query("select * from tbl_seat_other a 
                                            INNER JOIN tbl_seat b ON a.seat_id=b.seat_id 
                                            where b.seat_no='".$iii.$char."' and a.seat_other_date = '$dateseatt' and a.fares_id = '2' and b.class_id = '5'"));
                                          $seatst = mysql_fetch_array(mysql_query("select * from tbl_seat where seat_no='".$iii.$char."' and seat_st = '0' and class_id = '5'"));
                                          $value_seat = mysql_fetch_array(mysql_query("select * from tbl_reservedet a
                                            INNER JOIN (tbl_reserve b,tbl_calfares c,tbl_class cl,tbl_seat d)
                                            ON (a.reserve_id=b.reserve_id AND b.cal_id=c.cal_id AND c.class_id=cl.class_id AND a.seat_id=d.seat_id)
                                            where d.seat_no='".$iii.$char."' and a.reservedet_date = '$dateseatt' and c.fares_id = '2' and cl.ship_id = '2' and b.reserve_cancel = '0' and b.reserve_status != 'D' and a.reservedet_st != '3' and d.class_id = '5'"));
